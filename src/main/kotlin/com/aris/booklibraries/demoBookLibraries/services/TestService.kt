...
class TestService {
    ...
    fun init() {
        ...
        userService.save(User(id= null, email = "nikos@gmail.com", firstName = "nikos", lastName = "papadopoulos") )
        userService.save(User(id= null, email = "elina@gmail.com", firstName = "elina", lastName = "oikonomou") )
